defmodule TestingPresenceWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule TestingPresence.MyChannel do
        use TestingPresenceWeb, :channel
        alias TestingPresence.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :testing_presence,
                        pubsub_server: TestingPresence.PubSub
end
